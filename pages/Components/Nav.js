      ...
      <nav className="bg-white px-2 sm:px-4 py-2.5 0 fixed w-full z-20 top-0 left-0 border-b border-gray-200 ">
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div
            ...
            id="navbar-sticky"
          >
            <ul className={`flex flex-col p-4 mt-4 border  bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white ${nav}  dark:border-gray-700`}>
              <li>
                <a
                  href="#"
